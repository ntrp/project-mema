...
Use the seeded `Test - ...` media profiles to exercise audio status, subtitle modes,
external subtitle import, unwanted subtitle/audio marking, chapter actions, and other-file actions.
