...
func soapDispatcherWithContent(tree *content.Tree) *soap.Dispatcher {
	...
	dispatcher.Register("/dlna/control/content-directory", ssdp.ContentDir, contentDirectoryActions(tree, "http://127.0.0.1:18080", func() int { return 0 }, testRendererProfile))
	return dispatcher
}
