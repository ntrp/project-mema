...
func (s *Engine) searchCardigann(ctx context.Context, config Config, query string, mediaType string) ([]Release, error) {
...
func (s *Engine) testCardigann(ctx context.Context, config Config) TestResult {
	def, err := s.loader.load(ctx, config.DefinitionID)
	if err != nil {
...
func (s *Engine) parseCardigannResponse(
	ctx context.Context,
...
func (s *Engine) parseCardigannHTML(
	ctx context.Context,
	def cardigannDefinition,
	config Config,
	templateCtx cardigannContext,
...
func (s *Engine) parseCardigannJSON(
	ctx context.Context,
	def cardigannDefinition,
	config Config,
	templateCtx cardigannContext,
