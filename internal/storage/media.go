...
const mediaItemSelectFields = `
	...
	m.genres, m.keywords, m.facts, m.seasons, m.cast_members, m.crew_members, m.recommendations, m.similar_media,
...
func scanMediaItem(row pgx.Row) (MediaItem, error) {
	...
	scanMediaMetadata(&item.MediaMetadataSnapshot, genres, keywords, facts, seasons, cast, crew, recommendations, similar)
