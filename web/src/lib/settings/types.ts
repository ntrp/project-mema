...
export type SubtitleProviderCatalogEntry = S['SubtitleProviderCatalogEntry'];
export type SubtitleProviderField = S['SubtitleProviderField'];
export type SubtitleProviderRequest = S['SubtitleProviderRequest'];
export type SubtitleProviderRuntimeStatus = S['SubtitleProviderRuntimeStatus'];
export type SubtitleProviderSettingValue = S['SubtitleProviderSettingValue'];
