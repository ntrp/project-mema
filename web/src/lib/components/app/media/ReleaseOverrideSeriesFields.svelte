<script lang="ts">
	...
	import type { ReleaseOverrideDraft } from './releaseOverrideDetails';
	import { episodeNumbers, seasonOptions, selectedSeason } from './releaseOverrideSeriesOptions';
	import ReleaseOverrideEpisodeSelect from './ReleaseOverrideEpisodeSelect.svelte';
	import ReleaseOverrideSeasonSelect from './ReleaseOverrideSeasonSelect.svelte';
