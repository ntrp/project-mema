<script lang="ts">
	...
	import CustomFormatForm from '$lib/components/settings/custom-formats/CustomFormatForm.svelte';
	import CustomFormatImportModal from '$lib/components/settings/custom-formats/CustomFormatImportModal.svelte';
	import CustomFormatTestParsingModal from '$lib/components/settings/custom-formats/CustomFormatTestParsingModal.svelte';
